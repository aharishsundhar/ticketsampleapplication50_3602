...
APPLICATION='/ticketsampleapplication50'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication50-desktop:1.0'
...
helm install --name ticketsampleapplication50-3602 ./helm
if [ $? -eq 0 ]; then
